...
input { padding: 0.6rem 0.8rem; border-radius: 6px; border: 1px solid #ddd; }
.actions { display:flex; justify-content:flex-end; }
.login-btn { padding: 0.6rem 1rem; border-radius: 999px; border: none; background:#1a1a1a; color:#fff }
